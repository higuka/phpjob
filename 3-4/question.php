...
<?php
    ...
    <input name="test2" type="radio" value="" />
    <?php echo $value;
}
?>
...
foreach ($test3 as $value) { ?>
    <input name="test3" type="radio" value="" />
    <?php echo $value;
}
?>
...
<input type="hidden" name="test2" value="<?php echo $test2; ?>" /> 
<input type="hidden" name="test3" value="<?php echo $test3; ?>" /> 
